...
namespace DiscordBot.Infrastructure.Migrations
{
    ...
    [Migration("20260710231052_AddWalletReservations")]
    partial class AddWalletReservations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiscordBot.Domain.Entities.GameBotPublishAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("GameBotPublishActions", (string)null);
                });
            ...
            modelBuilder.Entity("DiscordBot.Domain.Entities.GameEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("GuildDiscordId")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.HasIndex("GuildId", "EventType", "CreatedAt");
            ...
            modelBuilder.Entity("DiscordBot.Domain.Entities.GameRuntimeToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("GameRuntimeTokens", (string)null);
                });

            modelBuilder.Entity("DiscordBot.Domain.Entities.GameSandboxAccess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GameVersionId", "GuildDiscordId", "UserDiscordId")
                        .IsUnique();

                    b.ToTable("GameSandboxAccess", (string)null);
                });
            ...
            modelBuilder.Entity("DiscordBot.Domain.Entities.GameVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("GameDefinitionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GameDefinitionId", "Status");

                    b.HasIndex("GameDefinitionId", "Version")
                        .IsUnique();
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5d9982f9-6da7-41d8-8074-b241102c84a4"),
                            ...
                            GameDefinitionId = new Guid("8f763e4f-d09e-48f5-b77b-406ecef81f98"),
                            ...
                            PublishedAt = new DateTimeOffset(new DateTime(2026, 7, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Status = "Published",
                        ...
                        new
                        {
                            Id = new Guid("ddfdc3c0-53fb-45cb-b5aa-3e942ed9d892"),
                            ActivityRoute = "/games/roulette",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            GameDefinitionId = new Guid("77cfca31-9574-4f30-8ac5-e87d1eb65663"),
            ...
            modelBuilder.Entity("DiscordBot.Domain.Entities.WalletReservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GuildId", "DiscordUserId", "Status", "ExpiresAtUtc");
            ...
            modelBuilder.Entity("DiscordBot.Domain.Entities.GameBotPublishAction", b =>
                {
                    b.HasOne("DiscordBot.Domain.Entities.GameEvent", "GameEvent")
                        .WithMany("BotPublishActions")
            ...
            modelBuilder.Entity("DiscordBot.Domain.Entities.GameEvent", b =>
                {
                    b.HasOne("DiscordBot.Domain.Entities.GameVersion", "GameVersion")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("DiscordBot.Domain.Entities.GameVersion", b =>
                {
                    b.HasOne("DiscordBot.Domain.Entities.PlatformGameDefinition", "GameDefinition")
                        .WithMany("Versions")
            ...
            modelBuilder.Entity("DiscordBot.Domain.Entities.GameEvent", b =>
                {
                    b.Navigation("BotPublishActions");
                });
