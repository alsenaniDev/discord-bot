...
public static class RouletteRuntimeStates
{
    ...
    public static bool CanTransition(string current, string next)
    {
        ...
        return current switch
        {
            ...
            BettingOpen => next is Spinning or Settling or Completed or Cancelled,
            ...
            Completed or Cancelled or Expired => false,
            _ => false
        };
    }
    ...
    public static bool IsTerminal(string status) => status is Completed or Cancelled or Expired;
}
