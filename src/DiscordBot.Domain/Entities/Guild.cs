...
public class Guild : BaseEntity
{
    ...
    public RouletteGuildSettings? RouletteSettings { get; set; }
    ...
    public ICollection<GameWallet> GameWallets { get; set; } = [];
    public ICollection<GameWalletTransaction> GameWalletTransactions { get; set; } = [];
