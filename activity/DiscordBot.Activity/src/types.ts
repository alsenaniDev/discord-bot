...
export interface MyActiveRouletteRoom { hasRoom: boolean; roomId?: string | null; status?: 'Waiting' | 'InProgress' | string | null; isHost: boolean; }
