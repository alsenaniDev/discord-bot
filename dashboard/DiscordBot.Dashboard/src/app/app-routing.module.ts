...
const routes: Routes = [
  ...
  { path: 'auth/callback', component: CallbackComponent },
  {
    ...
    children: [
      ...
      { path: 'guilds/:id/overview', component: OverviewComponent },
      { path: 'guilds/:id/settings', component: SettingsComponent },
      { path: 'guilds/:id/tickets', component: TicketsComponent },
      { path: 'guilds/:id/moderation', component: ModerationComponent },
      { path: 'guilds/:id/modules', component: ModulesComponent },
      { path: 'guilds/:id/logs', component: LogsComponent },
      { path: 'guilds/:id/reaction-roles', component: ReactionRolesComponent },
      { path: 'guilds/:id/subscription', component: SubscriptionComponent },
