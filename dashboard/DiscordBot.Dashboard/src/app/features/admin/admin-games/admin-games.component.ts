...
export class AdminGamesComponent implements OnInit {
  ...
  form = this.fb.group({
    key: ['', [Validators.required, Validators.pattern(/^[a-z0-9][a-z0-9-]{0,63}$/)]], name: ['', Validators.required], description: [''], iconUrl: [''], activityRoute: ['/games/', Validators.required], requiredPlan: ['free', Validators.required],
